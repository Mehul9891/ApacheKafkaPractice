    ...
    public static void main(String [] args) throws Exception{
        {
            ...
            Status status = twitter.updateStatus("Good Morning !!!! Have a happy weekend");
          ...
          //  twitterStream.filter(query);
            ...
            Status myStatus = twitter.tweets().showStatus(3);
            System.out.println("My status :"+ myStatus.getText());
            producer.close();
            Thread.sleep(5000);
